...
- **Phone:** +91-8604304079
- **Email:** hsachan295@gmail.com, harsh.22gcebai118@galgotiacollege.edu
- **LinkedIn:** https://www.linkedin.com/in/harsh-sachan-b3b24a2a2
- **GitHub:** https://github.com/hsachan295-source
- **LeetCode:** https://leetcode.com/Harshsachan2001/
- **Languages:** English (Professional), Hindi (Native)
- **Status:** Final year B.Tech CSE (AI Specialization) student (Graduating June 2026), looking for positions
- **Constraints:** None (Open to remote, hybrid, or relocation)

## Education

| Degree | Period | Institution | Key Topics / Grades |
|--------|--------|-------------|------------|
| B.Tech in Computer Science Engineering (AI Specialization) | 2022 - 2026 | Galgotias College of Engineering and Technology (Greater Noida, UP) | Machine Learning, Deep Learning, NLP, Computer Vision, GenAI & Agents, SQL/NoSQL, Vector DBs. CGPA: 8.12/10.0 |

## Professional Experience

### Lead Developer & AI Architect - Independent Projects (2024 - Present)
Greater Noida, UP, India
- Delivered 13+ end-to-end AI/ML projects spanning predictive modeling, NLP, Computer Vision, Generative AI, RAG pipelines, Agentic AI, REST APIs, and interactive BI dashboards.
- Owned the full ML lifecycle: EDA, feature engineering, model training & evaluation, REST API development, Docker containerization, and cloud deployment.
...
- **Machine Learning & Deep Learning**: Supervised & Unsupervised Learning, Regression, Classification, Clustering, Decision Trees, Random Forest, XGBoost, ANN, CNN, RNN, LSTM, GRU
- **Data Analytics & BI**: Business Intelligence, Exploratory Data Analysis (EDA), Feature Engineering, Data Visualization, Power BI dashboard design, Star Schemas

### Software & Cloud Tools
- **Cloud & Deployment**: Docker, Hugging Face Spaces, Google Cloud Platform (GCP), Oracle Cloud Infrastructure (OCI)
- **Development Tools**: Git, GitHub, VS Code, Jupyter Notebooks
...
## References
More references and academic/project recommendations available upon request.
